...
DEFAULT_CONFIG = {
    ...
    "cron": {
        ...
        # (long TTS audio, big exports) need more than 30s. Config-only: this knob has NO env
        # override. Keep in sync with cron.scheduler_script._DEFAULT_MEDIA_SEND_TIMEOUT.
