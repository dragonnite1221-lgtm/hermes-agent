...
def _update_via_zip(args, *, had_desktop_app_before_update: bool = False) -> bool:
    ...
    # See #30271.
    # The returned cleanup dict is deliberately dropped here: unlike the git path's
    # `_verify_fleet_after_update`, this fallback runs no gateway restart phase and therefore has no
    # killed_pids/restarted_services bookkeeping (nor a plan reconciliation) to fold it into.
